...
<div class="card-footer">
    <nav aria-label="Navegacion por paginas">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item <?php echo (isset($page) && $page ==1) ? 'disabled' : '';?>">
                <a class="page-link" href="/users?page=<?php echo (isset($page) && $page > 1) ?  $page-1  : '';?>&<?php echo $queryString; ?>" aria-label="Previous">
                    <span aria-hidden="true">&lt;</span>
                    <span class="sr-only">Previous</span>
                </a>
            </li>
            <li class="page-item active"><a class="page-link" href="/users?page=<?php echo $page ?>"><?php echo $page ?></a></li>
            <li class="page-item <?php echo (isset($page) && $page == $numberOfPages) ? 'disabled' : '';?>">
                <a class="page-link" href="/users?page=<?php echo (isset($page) && $page < $numberOfPages) ?  $page+1  : '';?>&<?php echo $queryString; ?>" aria-label="Next">
                    <span aria-hidden="true">&gt;</span>
                    <span class="sr-only">Next</span>
                </a>
            </li>
            <li class="page-item <?php echo (isset($page) && $page == $numberOfPages) ? 'disabled' : '';?>">
                <a class="page-link" href="/users?page=<?php echo $numberOfPages ?>&<?php echo $queryString; ?>" aria-label="Last">
